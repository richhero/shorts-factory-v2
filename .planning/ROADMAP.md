...
## 🎯 Milestone 1: Robust UI Infrastructure (Current)
...
- [ ] **Task 2-2: Subtitle Generation & Burn-in Logic**.
- [ ] **Task 2-3: Multi-language Support** (En/Jp translation UI sync).

## 🎬 Milestone 3: Professional Workflow Integration
- [ ] **Task 3-1: Premiere Pro XML Export**.
- [ ] **Task 3-2: CapCut PC JSON Export**.
- [ ] **Task 3-3: Vrew SRT Export**.
